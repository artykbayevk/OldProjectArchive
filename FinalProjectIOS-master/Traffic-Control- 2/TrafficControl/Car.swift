...
class Car: SKSpriteNode {
    ...
    func setup(){
        ...
        brakesLight()
        indicatorLights()
        physicsBody = SKPhysicsBody(rectangleOfSize: CGSize(width: size.width * 0.9, height: size.height * 0.9))
