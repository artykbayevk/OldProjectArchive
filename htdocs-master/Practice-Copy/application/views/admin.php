...
<body>
    <div id="mainp">
      ...
      <td><img src="<?php echo base_url()?>img/admin.png" class="img-thumbnail" alt="Cinque Terre" width="255" height="180"></td></tr>
      <?php }else{?>
      <td><label>USER</label></td>  
      <td><img src="<?php echo base_url()?>img/user.jpg" class="img-thumbnail" alt="Cinque Terre" width="255" height="100"></td></tr> 
      <?php }?>
      <tr>
      <td><label>Username:</label></td><td><label><?php echo $this->session->userdata('username')?></label></td>
      </tr>
      <tr>
      <td><label>Email:</label></td><td><label><?php echo $this->session->userdata('uemail')?><label></td> 
      </tr>
      </table>
</div>
</div>
