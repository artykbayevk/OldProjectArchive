...
<body>
  ...
  <img src="<?php echo base_url()?>img/lang.jpg" class="img-thumbnail" alt="Cinque Terre" width="304" height="236"> 
  <p class="muted">Language is the ability to acquire and use complex systems of communication, particularly the human ability to do so, and a language is any specific example of such a system. The scientific study of language is called linguistics.
