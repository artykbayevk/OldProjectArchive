...
<body>
   ...
   <h1>Update this Subject
      <small>Price of subject' retakes</small>
   </h1>
</div>
	<div class="container">
    <div class="row">
        <form role="form" method = "post" action="<?php echo base_url();?>index.php/credit/updateCredit?id=<?php echo $_GET['id']; ?>">
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control"  name="credit" placeholder="Enter Sum" required>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                <div class="form-group">
