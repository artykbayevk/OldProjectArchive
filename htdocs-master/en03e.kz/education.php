...
<body>
	...
	$sql = "DELETE FROM timetables WHERE id='".$del."'";
...
<div class="accordion">
			...
			if($_SESSION['id']==1){
				...
				<a class='accordion-section-title' href='#accordion-0'>Admin's page for download news and timetables</a>
				<div id='accordion-0' class='accordion-section-content'>
					<p><form method='post' action='addtimetable.php' enctype='multipart/form-data'>
							...
							<label>Add news and their content</label>
			...
			<div class="accordion-section">
				<a class="accordion-section-title" href="#accordion-1">Timetable for disciplines and for finals </a>
					...
					<p>
						...
						if ($result->num_rows > 0) {
							while($row = $result->fetch_assoc()) {
								?>
								<td><img width="580px" src="<?php echo $row['picture']?>"></td></tr>
								<tr><td align="center" style="background-color:black; color:white; font-family:Georgia, "Times New Roman", Times, serif;" ><?php echo $row["tname"] ?></td></tr>
								<?php if($_SESSION['id']==1){?><tr><td align="center"><a href="education.php?delete1=<?php echo $row["id"] ?>">Delete</a></td></tr><?php }?>
								<?php
							    $nums++;
						    }
						} else {
			...
			<div class="accordion-section">
				<a class="accordion-section-title" href="#accordion-2">News about lessons and exams </a>
				<div id="accordion-2" class="accordion-section-content">
					<p>
						...
						if ($result->num_rows > 0) {
							while($row = $result->fetch_assoc()) {
								?>
								<td align="center" style="width:1000px;"><?php echo $row['title']?></td></tr>
								<tr><td align="center" style="background-color:black; color:white; font-family:Georgia, "Times New Roman", Times, serif;" ><?php echo $row["content"] ?></td></tr>
								<?php if($_SESSION['id']==1){?><tr><td align="center"><a href="education.php?delete=<?php echo $row["id"] ?>">Delete</a></td></tr><?php }?>
								<?php
							    $nums++;
						    }
						} else {
